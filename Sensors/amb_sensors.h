...
enum{FOREHEAD_ACCEL=0,FOREHEAD_GYRO,SFE_1_ACCEL,SFE_1_MAGNO,SFE_1_GYRO,FOREHEAD_TEMP,SFE_2_ACCEL,SFE_2_MAGNO,SFE_2_GYRO};//sensor enums for sensor detect
...
#define FIRST_BUS_READS (uint32_t)((1<<FOREHEAD_ACCEL)|(1<<FOREHEAD_GYRO)|(1<<SFE_1_ACCEL)|(1<<SFE_1_MAGNO)|(1<<SFE_1_GYRO)|(1<<FOREHEAD_TEMP))
...
#define LSM_330_GYRO_FIFO_SUB 0x2E
